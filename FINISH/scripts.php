<?php
/** Z:\openserver\domains\test.mediadoma.com\wp-content\plugins\live-composer-page-builder\includes\scripts.php
...
final class DSLC_Scripts{
	...
	public static function dslc_load_scripts_frontend() {
		...
		/**********************************************
		 * ИСПРАВЛЕНИЕ АНИМ. ОБЪЕКТОВ В IE START (dsv)
		***********************************************/
		...
		/**********************************************
		 * ИСПРАВЛЕНИЕ АНИМ. ОБЪЕКТОВ В IE END (dsv)
		***********************************************/
